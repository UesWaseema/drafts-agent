import logging
from .interspire_subject_analyzer import InterspireSubjectAnalyzer
from .interspire_content_analyzer import InterspireContentAnalyzer
...
class InterspireCompositeScorer:
    ...
    def score_single_draft(self, draft_id, subject_line, email_content):
        ...
        try:
            subject_analysis = self.subject_analyzer.analyze_subject_line(subject_line)
            ...
            subject_analysis = {"error": str(e), "score": 0.0} # Default to 0 score on error

        try:
            content_analysis = self.content_analyzer.analyze_content(email_content)
            ...
            content_analysis = {"error": str(e), "score": 0.0} # Default to 0 score on error
